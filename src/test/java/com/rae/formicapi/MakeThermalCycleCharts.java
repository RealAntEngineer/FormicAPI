...
public class MakeThermalCycleCharts {
    ...
    public static void main(String[] args) {
        ...
        SpecificRealGazState compressionStatesPr = WaterCubicEOSTransformationHelper.isentropicCompression(startPR,30);
        ...
        SpecificRealGazState endOfHeatingPR = WaterCubicEOSTransformationHelper.isobaricTransfer(
                compressionStatesPr,2e6f);
        System.out.println("End of Heating States: " + endOfHeatingPR);
        SpecificRealGazState expansionStatesPr = WaterCubicEOSTransformationHelper.isentropicExpansion(endOfHeatingPR,30);
